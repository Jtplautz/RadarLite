...
public class RadarLiteIdentityFactory : IDesignTimeDbContextFactory<RadarLiteIdentityContext> {
    public RadarLiteIdentityContext CreateDbContext(string[] args)
    {
        ...
        services.AddDbContextPool<RadarLiteIdentityContext>(options =>
        {
            ...
            options.UseSqlServer(configuration.GetConnectionString("RadarLiteIdentityContextConnection"), sqlOptions =>
            {
