...
export async function GetCitiesAsync(): Promise<Location[]> {
  const path = "http://localhost:7506/location/cities"; //"http://192.168.1.192:7506/Cities";
...
export async function GetCityAsync(zipcode: number): Promise<Location> {
  const path = "http://localhost:7506/location/city/" + zipcode; //"http://192.168.1.192:7506/Cities";
